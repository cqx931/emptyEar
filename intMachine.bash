run_foreignEar1="cd emptyear && python subEar.py international1"
run_foreignEar2="cd emptyear && python subEar.py international2"
run_foreignEar3="cd emptyear && python subEar.py international3"
